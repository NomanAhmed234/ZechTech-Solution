...
<div class="mx-auto col-md-10 p-4">
    <h3 class="mx-4 my-4 font-bold text-2xl mb-4">Blog</h3>
          ...
          { ?>
            ...
            <div class="g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm position-relative">
              <div class="col-12 d-lg-block">
                <img class="bd-placeholder-img object-cover object-center w-full" style="object-fit:cover;" src="<?=get_image($row['image'])?>">
              </div>
