    ...
    <div class="container flex flex-wrap px-5 md:mx-auto py-1 flex-row items-center justify-between">
      ...
      <div class="flex">
        <nav
          ...
          <a class="mr-5 active" href="<?=ROOT?>/home">Home</a>
          <a class="mr-5" href="<?=ROOT?>/blog">Blog</a>
          <a class="mr-5" href="#services">Services</a>
          <a class="mr-5" href="#projects">Projects</a>
        </nav>

        <a href="#contact">
        <button
          class="hidden contact-btn md:inline-flex items-center border-2 py-1 px-3 focus:outline-none rounded-full text-base md:mt-0">Contact
          Us
        </button>
      </a>
        ...
        <div class="dropdown text-end ml-4">
          <a href="#" class="flex link-dark text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
      <div
        ...
        <div class="flex justify-center">
          <button
            class="inline-flex get-btn font-medium text-white border-0 py-2 px-2 focus:outline-none rounded-full text-lg">GET
            IN TOUCH</button>
          <button
            class="ml-4 inline-flex video-btn font-medium text-black bg-gray-100 py-2 px-2 focus:outline-none border-2 rounded-full text-lg">WATCH
            VIDEO</button>
        </div>
      </div>
